...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-QM89F54;Initial Catalog=CMS;Integrated Security=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Declaration>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserId, "IX_Declarations_UserId");
        ...
        modelBuilder.Entity<Monitoring>(entity =>
        {
            ...
            entity.HasIndex(e => e.DeclarationId, "IX_Monitoring_DeclarationId");
        ...
        modelBuilder.Entity<Payment>(entity =>
        {
            ...
            entity.HasIndex(e => e.DeclarationId, "IX_Payments_DeclarationId");

            entity.HasIndex(e => e.ProductId, "IX_Payments_ProductId");

            entity.HasIndex(e => e.UserId, "IX_Payments_UserId");

            entity.HasIndex(e => e.TransactionId, "UQ__Payments__55433A6A1ADCF7C5")
                .IsUnique()
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.HasIndex(e => e.DeclarationId, "IX_Products_DeclarationId");
        ...
        modelBuilder.Entity<RoleDetail>(entity =>
        {
            ...
            entity.HasIndex(e => e.RoleId, "IX_RoleDetails_RoleId");
        ...
        modelBuilder.Entity<Shipment>(entity =>
        {
            ...
            entity.HasIndex(e => e.DeclarationId, "IX_Shipment_DeclarationId");
